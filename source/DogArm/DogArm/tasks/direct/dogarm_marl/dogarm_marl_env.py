...
from .dogarm_marl_env_cfg import DogarmMarlEnvCfg


class DogarmMarlEnv(DirectMARLEnv):
    cfg: DogarmMarlEnvCfg

    def __init__(self, cfg: DogarmMarlEnvCfg, render_mode: str | None = None, **kwargs):
